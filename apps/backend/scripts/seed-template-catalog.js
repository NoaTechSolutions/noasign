...
const RECEIPT_STANDARDS = [
  ...
  },
  {
    ...
    isDefault: false,
    fieldMappingJson: {
      receipt_number: { type: 'text', x: 135, lineTop: 192, font: 'Carlito-Bold', size: 11, color: '#12235c' },
      date: { type: 'text', x: 355, lineTop: 192, font: 'Carlito-Bold', size: 11, color: '#12235c' },
      client: { type: 'text', x: 150, lineTop: 247, font: 'Carlito', size: 11, color: '#12235c' },
      payment_for: { type: 'text', x: 150, lineTop: 300, font: 'Carlito', size: 11, color: '#12235c' },
      amount: { type: 'currency', x: 200, lineTop: 366, font: 'Carlito-Bold', size: 11, color: '#12235c' },
      payment_method: { type: 'text', x: 335, lineTop: 366, font: 'Carlito', size: 10, color: '#12235c', labels: METHOD_LABELS },
      received_by: { type: 'text', x: 520, lineTop: 366, font: 'Carlito', size: 9, color: '#12235c' },
      notes: { type: 'text', x: 210, lineTop: 421, font: 'Carlito', size: 10, color: '#12235c' },
    },
  },
  {
    ...
    isDefault: false,
    fieldMappingJson: {
      client: { type: 'text', x: 158, lineTop: 283, font: 'Carlito', size: 12 },
      payment_for: { type: 'text', x: 138, lineTop: 313, font: 'Carlito', size: 12 },
      date: { type: 'text', x: 465, lineTop: 313, font: 'Carlito', size: 12 },
      amount: { type: 'currency', x: 152, lineTop: 346, font: 'Carlito', size: 12 },
      payment_method: { type: 'text', x: 472, lineTop: 346, font: 'Carlito', size: 11, labels: METHOD_LABELS },
      received_by: { type: 'text', x: 142, lineTop: 374, font: 'Carlito', size: 12 },
      receipt_number: { type: 'text', x: 42, lineTop: 415, font: 'Montserrat-Black', size: 18 },
    },
  },
  {
