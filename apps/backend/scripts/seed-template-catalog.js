...
const RECEIPT_STANDARDS = [
  ...
  },
  {
    ...
    isDefault: false,
    fieldMappingJson: {
      receipt_number: { type: 'text', x: 82, lineTop: 184, font: 'Carlito-Bold', size: 11, color: '#12235c' },
      date: { type: 'text', x: 332, lineTop: 184, font: 'Carlito-Bold', size: 11, color: '#12235c' },
      client: { type: 'text', x: 82, lineTop: 239, font: 'Carlito', size: 11, color: '#12235c' },
      payment_for: { type: 'text', x: 82, lineTop: 292, font: 'Carlito', size: 11, color: '#12235c' },
      amount: { type: 'currency', x: 82, lineTop: 358, font: 'Carlito-Bold', size: 11, color: '#12235c' },
      payment_method: { type: 'text', x: 262, lineTop: 358, font: 'Carlito', size: 10, color: '#12235c', labels: METHOD_LABELS },
      received_by: { type: 'text', x: 436, lineTop: 358, font: 'Carlito', size: 9, color: '#12235c' },
      notes: { type: 'text', x: 82, lineTop: 413, font: 'Carlito', size: 10, color: '#12235c' },
  ...
  },
  {
    ...
    fieldMappingJson: {
      ...
      payment_for: { type: 'text', x: 138, lineTop: 311, font: 'Carlito', size: 13.5 },
      date: { type: 'text', x: 465, lineTop: 311, font: 'Carlito', size: 13.5 },
      ...
      received_by: { type: 'text', x: 142, lineTop: 372, font: 'Carlito', size: 13.5 },
