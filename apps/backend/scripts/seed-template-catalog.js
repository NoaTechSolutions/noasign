...
const RECEIPT_STANDARDS = [
  {
    ...
    fieldMappingJson: {
      ...
      other_label: { type: 'text', x: 470, lineTop: 278, font: 'Carlito', size: 9 },
  ...
  },
  {
    ...
    isDefault: false,
    fieldMappingJson: {
      receipt_number: { type: 'text', x: 135, lineTop: 205, font: 'Carlito-Bold', size: 11, color: '#12235c' },
      date: { type: 'text', x: 355, lineTop: 205, font: 'Carlito-Bold', size: 11, color: '#12235c' },
      client: { type: 'text', x: 250, lineTop: 250, font: 'Carlito', size: 11, color: '#12235c' },
      payment_for: { type: 'text', x: 250, lineTop: 303, font: 'Carlito', size: 11, color: '#12235c' },
      amount: { type: 'currency', x: 200, lineTop: 375, font: 'Carlito-Bold', size: 11, color: '#12235c' },
      payment_method: { type: 'text', x: 335, lineTop: 375, font: 'Carlito', size: 10, color: '#12235c', labels: METHOD_LABELS },
      received_by: { type: 'text', x: 520, lineTop: 375, font: 'Carlito', size: 9, color: '#12235c' },
      notes: { type: 'text', x: 210, lineTop: 415, font: 'Carlito', size: 10, color: '#12235c' },
    },
  },
  {
    ...
    isDefault: false,
    fieldMappingJson: {
      client: { type: 'text', x: 158, lineTop: 288, font: 'Carlito', size: 12 },
      payment_for: { type: 'text', x: 138, lineTop: 318, font: 'Carlito', size: 12 },
      date: { type: 'text', x: 465, lineTop: 318, font: 'Carlito', size: 12 },
      amount: { type: 'currency', x: 152, lineTop: 351, font: 'Carlito', size: 12 },
      payment_method: { type: 'text', x: 472, lineTop: 351, font: 'Carlito', size: 11, labels: METHOD_LABELS },
      received_by: { type: 'text', x: 142, lineTop: 379, font: 'Carlito', size: 12 },
      receipt_number: { type: 'text', x: 175, lineTop: 415, font: 'Montserrat-Black', size: 18 },
    },
  },
  {
