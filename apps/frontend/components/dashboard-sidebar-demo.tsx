  ...
  return (
    <div className="relative flex min-h-screen w-full overflow-hidden bg-[color:var(--bg-page)]/70 backdrop-blur md:flex-row xl:overflow-visible">
      ...
      {documentSuccessMessage ? (
        <div className="fixed inset-0 z-[70] flex items-start justify-center md:items-center bg-slate-950/35 p-4 pt-20 md:pt-0">
          <button
            type="button"
...
function CustomerDeleteDialog({ customer, isDeleting, onCancel, onConfirm }: {
  ...
  return (
    <div role="dialog" aria-modal="true" className="fixed inset-0 z-50 flex items-start justify-center md:items-center bg-black/40 p-4 pt-20 md:pt-0">
...
function CustomerTypeSelectorDialog({
  ...
  return (
    <div
      role="dialog"
      aria-modal="true"
      className="fixed inset-0 z-[60] flex items-start justify-center md:items-center bg-black/40 p-4 pt-20 md:pt-0"
    >
...
function CustomerFormDrawer({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center md:items-center bg-black/40 p-4">
      ...
      {confirmDialog ? (
        <div className="fixed inset-0 z-[80] flex items-start justify-center md:items-center bg-slate-950/30 p-4 pt-20 md:pt-0 backdrop-blur-sm">
...
function ForcePasswordChangeModal({
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-start justify-center md:items-center bg-slate-950/45 p-4 pt-20 md:pt-0 backdrop-blur-sm">
...
function BillingPanel({
  ...
  return (
    <section className="grid gap-4">
      ...
      {plansModalOpen ? (
        <div className="fixed inset-0 z-50 flex items-start justify-center md:items-center bg-slate-950/55 p-4 pt-20 md:pt-0 backdrop-blur-sm">
