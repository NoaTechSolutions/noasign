...
export function MemberTableRow({
  ...
  return (
    <tr className="member-row">
      ...
      <td>
        <div className="member-row__actions" ref={menuRef}>
          <button type="button" className="kebab-menu" onClick={() => setMenuOpen(!menuOpen)}>
          ...
          {menuOpen && (
            <div className="dropdown-menu">
              <button type="button" onClick={() => { onView(user); setMenuOpen(false); }}>
              ...
              {!isSelf && (
                <>
                  <button type="button" onClick={() => { onEdit(user); setMenuOpen(false); }}>
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <button type="button" onClick={() => { onResetPassword(user); setMenuOpen(false); }}>
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  {user.status === 'ACTIVE' ? (
                    <button type="button" className="dropdown-item--danger" onClick={() => { onDeactivate(user); setMenuOpen(false); }}>
                      <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <button type="button" onClick={() => { onReactivate(user); setMenuOpen(false); }}>
                      <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
