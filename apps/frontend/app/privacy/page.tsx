...
export default function PrivacyPage() {
  return (
    <main style={{ maxWidth: 720, margin: "80px auto", padding: "0 20px", fontFamily: "sans-serif" }}>
      ...
      <h1 style={{ fontSize: 24, fontWeight: 500, color: "#022977", marginTop: 24 }}>Privacy Policy</h1>
      <p style={{ color: "rgba(2,41,119,0.7)", lineHeight: 1.7 }}>
        This Privacy Policy will be published before launch. For any questions, contact{" "}
